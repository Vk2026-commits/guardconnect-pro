              ...
              <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-12">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                    <span className="text-lg font-bold text-primary">Free for Security Professionals to Sign Up!</span>
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">
                    {t('pricing.title')}
                  </h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <Card className="border-2">
                    <CardContent className="pt-6">
                      ...
                      <Button variant="outline" className="w-full" asChild>
                        <Link to="/auth?role=company">{t('pricing.free.button')}</Link>
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 border-primary relative">
                    ...
                    <CardContent className="pt-6">
                      <div className="text-center mb-6">
                        ...
                        <p className="text-primary font-semibold">{t('pricing.professional.trial')}</p>
                      </div>
                      <ul className="space-y-3 mb-6">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-5 w-5 text-primary mt-0.5" />
                      ...
                      <Button className="w-full" asChild>
                        <Link to="/auth?role=company">{t('pricing.professional.button')}</Link>
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2">
                    <CardContent className="pt-6">
                      ...
                      <Button variant="outline" className="w-full" asChild>
                        <Link to="/auth?role=company">{t('pricing.premium.button')}</Link>
                      </Button>
                    </CardContent>
                  </Card>
                </div>
